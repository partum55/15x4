...
export default function Footer() {
  ...
  return (
    <footer className="w-full min-h-[267px] bg-black text-white p-[clamp(24px,3.2vw,48px)] flex items-start justify-between gap-6 max-[767px]:flex-col max-[767px]:min-h-0 max-[767px]:gap-8">
