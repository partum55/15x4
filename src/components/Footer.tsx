    ...
    <footer className="footer">
      <div className="footer__col footer__col--nav">
        <nav className="footer__nav">
          <Link to="/events" className="footer__link">{t('nav.events')}</Link>
          <Link to="/lectures" className="footer__link">{t('nav.lectures')}</Link>
          <Link to="/about-us" className="footer__link">{t('nav.about')}</Link>
        </nav>
      ...
      <div className="footer__col footer__col--contact">
        <div className="footer__contact">
          <p className="footer__contact-label">{t('footer.contactLabel')}</p>
          <a href="mailto:example@gmail.com" className="footer__email">example@gmail.com</a>
        </div>
        <div className="footer__socials">
          <a href="#instagram" className="footer__social-link" aria-label="Instagram"><InstagramIcon /></a>
          <a href="#youtube" className="footer__social-link" aria-label="YouTube"><YouTubeIcon /></a>
        </div>
      </div>
    </footer>
  )
